...
class TvDatafeed:
    ...
    ws_headers = json.dumps({"Origin": "https://data.tradingview.com", 'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36'})
    ...
    def get_hist(
        ...
        self.__send_message(
            "quote_add_symbols", [self.session, 
                                  symbol,
        ...
        self.__send_message(
            "quote_fast_symbols", [self.session, 
                                   symbol, 
                                   "={\"adjustment\":\"splits\",\"currency-id\":\"USD\"}", 
                                ])
...
if __name__ == "__main__":
    ...
    print(tv.get_hist("SPY", "", fut_contract=1))
    print(
        tv.get_hist(
            "EICHERMOT",
            "NSE",
